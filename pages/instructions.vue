...
<template>
  <div class="container">
    ...
    <h1 class="text-6xl mb-8 font-medium">Каталог инструкций</h1>
    <div class="mb-6" v-for="item in data.filter(x=>x.products.length>0)" :key="item.id">
      <p class="text-3xl mb-6 font-medium">{{item.name}}</p>
      <div class="grid">
